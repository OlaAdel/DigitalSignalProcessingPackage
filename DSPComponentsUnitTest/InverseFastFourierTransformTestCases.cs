...
namespace DSPComponentsUnitTest
{
    ...
    public class InverseFastFourierTransformTestCases
    {
        ...
        public void IFFT_TestMethod1()
        {
            ...
            IFFT.InputFreqDomainSignal = UnitTestUtitlities.LoadSignal(@"TestingSignals/Signal1_FFT_Results.ds");
            List<float> outPutSamples = UnitTestUtitlities.LoadSignal("TestingSignals/Signal1_FFT.ds").Samples;
